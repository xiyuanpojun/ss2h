...
public class ReadExcelGw {
                    ...
                    protected void outputRow(String[] datas, int[] rowTypes, int rowIndex) {
                        ...
                        if (datas.length > 0 && null != datas[0] && !"".equals(datas[0].trim())) {
                            ...
                            if (i > 1) {
                                ...
                                if (i > 50000) {
                                    doList(dataList, zxName, request);
    ...
    private static void doList(List<List> li, String zxName, HttpServletRequest request) {
        ...
        if (defaultLimit < size) {
            ...
            for (int i = 0; i < part; i++) {
                ...
                ThreadInsertGw ti = new ThreadInsertGw(list, zxName, request);
            ...
            ThreadInsertGw ti = new ThreadInsertGw(li, zxName, request);
            Thread td = new Thread(ti);
            threads.add(td);
            td.start();
        }
